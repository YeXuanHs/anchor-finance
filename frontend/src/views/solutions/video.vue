<template>
  <div class="solution-detail-page">
    ...
    <!-- Hero Section -->
    <section class="hero-section" style="background: linear-gradient(135deg, #ff6b6b, #ee5a24);">
      <div class="container">
        <div class="hero-content">
          <div class="hero-icon">
            <el-icon :size="48"><VideoCamera /></el-icon>
          </div>
          <h1 class="hero-title">视频行业解决方案</h1>
          <p class="hero-desc">基于视频监控数据高并发、大容量、保密性强等特点，提供海量、弹性、高可靠、高性价比的视频云存储解决方案，满足各类视频数据存储场景。</p>
    ...
    <section class="section cta-section">
      <div class="container">
        <div class="cta-content">
          <h2>构建高效视频云平台</h2>
          <p>立即选购适合您的视频云产品，或联系我们的技术顾问获取定制方案</p>
...
const features = ref([
  { icon: 'Position', title: '大带宽支持', desc: '提供高达10Gbps的带宽，满足高清视频直播和大规模并发需求' },
  { icon: 'Cpu', title: '低延迟传输', desc: '优化网络架构，实现毫秒级延迟，确保实时视频流畅传输' },
  { icon: 'Connection', title: '全球CDN加速', desc: '覆盖全球的CDN节点，确保全球用户都能获得流畅观看体验' },
  { icon: 'DataLine', title: '弹性扩容', desc: '根据流量自动扩容，从容应对流量高峰，按需付费降低成本' }
])

const products = ref([
  { name: '直播入门版', price: 299, featured: false, specs: ['4核CPU', '8GB内存', '500GB SSD', '10Mbps带宽', '基础CDN加速'] },
  { name: '直播专业版', price: 599, featured: true, specs: ['8核CPU', '16GB内存', '1TB SSD', '50Mbps带宽', '全球CDN加速'] },
  { name: '直播企业版', price: 1299, featured: false, specs: ['16核CPU', '32GB内存', '2TB SSD', '100Mbps带宽', '专属CDN节点'] }
])

const usecases = ref([
  { title: '游戏直播', desc: '为游戏直播平台提供低延迟、高画质的直播服务，支持弹幕互动' },
  { title: '电商直播', desc: '支持大规模并发，保障直播带货流畅进行，提升转化率' },
  { title: '教育直播', desc: '提供稳定的音视频传输，支持互动教学，打造沉浸式学习体验' },
  { title: '企业直播', desc: '安全可靠的直播服务，满足企业会议、培训、发布会等需求' }
])
