  ...
  <div class="help-center-page">
    <el-card shadow="never" class="action-card">
      <div class="action-bar">
        <el-button type="primary" @click="handleAdd"><el-icon><Plus /></el-icon>添加帮助文档</el-button>
      </div>
    </el-card>
...
const fetchList = async () => {
  loading.value = true
  try {
    const data = await request.get({ url: '/api/admin/help' })
...
const handleAdd = () => { console.log('添加帮助文档') }
