...
type Menu struct {
	gorm.Model
	Name        string         `gorm:"type:varchar(64);not null" json:"name"`           // 菜单名称（中文）
	...
	Type        string         `gorm:"type:varchar(16);not null;index" json:"type"`     // admin/client/top/side/bottom
	...
	LanguageMap datatypes.JSON `gorm:"type:json" json:"language_map"`                  // 多语言 {"CN":"客户","HK":"客戶","US":"Customer"}
}
