    ...
    <el-card shadow="never">
      ...
      <el-row :gutter="20" style="margin-top: 20px;">
        <el-col :span="12">
          <el-card shadow="hover" class="stat-card accent">
            ...
            <div class="stat-label">回复工单数</div>
          </el-card>
        </el-col>
        <el-col :span="12">
          <el-card shadow="hover" class="stat-card accent">
      ...
      <div class="table-section">
        ...
        <el-table :data="dailyData" v-loading="tableLoading" style="width: 100%" border>
          ...
          <el-table-column prop="new_clients" label="新增客户" width="120" align="center" />
          <el-table-column prop="new_orders" label="新订单" width="120" align="center" />
          <el-table-column prop="completed_orders" label="完成订单" width="120" align="center" />
          <el-table-column prop="new_tickets" label="新工单" width="120" align="center" />
          <el-table-column prop="replied_tickets" label="回复工单" width="120" align="center" />
