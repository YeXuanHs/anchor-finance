        ...
        <el-tab-pane label="基本设置" name="basic">
          <el-form :model="basicSettings" label-width="120px" style="max-width: 640px; margin-top: 20px">
            <el-form-item label="站点名称">
              <el-input v-model="basicSettings.siteName" placeholder="智简魔方" />
            </el-form-item>
            <el-form-item label="站点Logo">
              <el-upload :limit="1" accept="image/*" :auto-upload="false" @change="handleLogoChange">
                <el-button><el-icon><Upload /></el-icon>上传Logo</el-button>
              </el-upload>
            </el-form-item>
          ...
          <el-form :model="emailSettings" label-width="120px" style="max-width: 640px; margin-top: 20px">
            <el-form-item label="邮件驱动">
              <el-select v-model="emailSettings.driver" style="width: 100%">
                <el-option v-for="o in emailDriverOptions" :key="o.value" :label="o.label" :value="o.value" />
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="加密方式">
              <el-select v-model="emailSettings.encryption" style="width: 100%">
                <el-option v-for="o in encryptionOptions" :key="o.value" :label="o.label" :value="o.value" />
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="发件人名称">
              <el-input v-model="emailSettings.fromName" placeholder="智简魔方" />
            </el-form-item>
          ...
          <el-form :model="smsSettings" label-width="120px" style="max-width: 640px; margin-top: 20px">
            <el-form-item label="短信服务商">
              <el-select v-model="smsSettings.provider" style="width: 100%">
                <el-option v-for="o in smsProviderOptions" :key="o.value" :label="o.label" :value="o.value" />
              </el-select>
            </el-form-item>
...
const paymentSettings = reactive({
  alipay: { enabled: false, appId: '', privateKey: '', publicKey: '', notifyUrl: 'https://anchorfinance.com/api/pay/alipay/notify' },
  wechat: { enabled: false, mchId: '', apiKey: '', certPath: '', notifyUrl: 'https://anchorfinance.com/api/pay/wechat/notify' },
})

const captchaSettings = reactive({
  imageEnabled: true, imageLength: 4, imageWidth: 120, imageHeight: 40,
  smsEnabled: false, smsLength: 6, smsExpire: 300,
  emailEnabled: false, emailLength: 6, emailExpire: 300,
  scenes: ['login', 'register'],
})

function handleLogoChange() { ElMessage.info('Logo上传功能待接入') }
