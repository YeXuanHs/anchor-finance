...
func RegisterRoutes(r *gin.RouterGroup, deps Deps) {
	...
	admin.Use(middleware.AuthRequired(), middleware.AdminRequired())
	{
		...
		admin.GET("/dashboard/expiring-products", dashboardHandler.GetExpiringProducts)
		admin.GET("/dashboard/online-clients", dashboardHandler.GetOnlineClients)
		admin.GET("/online-admins", handler.GetOnlineAdmins)
		...
		// 交易管理
		admin.GET("/transactions", transactionHandler.GetTransactions)

		// 产品管理
		admin.GET("/products", productHandler.GetList)
		admin.GET("/products/expiring", handler.GetExpiringProducts)
		...
		admin.GET("/homepage-features", featureHandler.List)
		admin.GET("/homepage-features/:id", featureHandler.GetDetail)
		admin.POST("/homepage-features", featureHandler.Create)
		admin.PUT("/homepage-features/:id", featureHandler.Update)
		admin.DELETE("/homepage-features/:id", featureHandler.Delete)
		admin.POST("/homepage-features/:id/status", featureHandler.SetStatus)
		...
		admin.GET("/crons", cronHandler.GetList)
		admin.GET("/crons/:id", cronHandler.GetDetail)
		admin.POST("/crons", cronHandler.Create)
		admin.PUT("/crons/:id", cronHandler.Update)
		admin.DELETE("/crons/:id", cronHandler.Delete)
		admin.POST("/crons/:id/status", cronHandler.SetStatus)
		admin.POST("/crons/:id/run", cronHandler.RunTask)
		admin.GET("/crons/:id/logs", cronHandler.GetLogs)
		...
		// Alias routes for frontend compatibility
		admin.GET("/clients/groups", clientGroupHandler.List)
		admin.GET("/clients/groups/:id", clientGroupHandler.Get)
		admin.POST("/clients/groups", clientGroupHandler.Create)
		admin.PUT("/clients/groups/:id", clientGroupHandler.Update)
		admin.DELETE("/clients/groups/:id", clientGroupHandler.Delete)
		...
		// Alias routes for frontend compatibility
		admin.GET("/ticket-departments", ticketDeptHandler.List)
		admin.GET("/ticket-departments/tree", ticketDeptHandler.GetTree)
		admin.POST("/ticket-departments", ticketDeptHandler.Create)
		admin.GET("/ticket-departments/:id", ticketDeptHandler.GetDetail)
		admin.PUT("/ticket-departments/:id", ticketDeptHandler.Update)
		admin.DELETE("/ticket-departments/:id", ticketDeptHandler.Delete)
		...
		admin.GET("/system/changelog", systemHandler.GetChangelog)
		...
		admin.GET("/log-cleaner/rules", logCleanerHandler.GetRules)
		admin.POST("/log-cleaner/rules", logCleanerHandler.CreateRule)
		admin.PUT("/log-cleaner/rules/:id", logCleanerHandler.UpdateRule)
		admin.DELETE("/log-cleaner/rules/:id", logCleanerHandler.DeleteRule)
		admin.POST("/log-cleaner/rules/:id/run", logCleanerHandler.RunRule)
		admin.POST("/log-cleaner/manual", logCleanerHandler.ManualClean)
		...
		admin.GET("/withdrawals", balanceHandler.GetWithdrawals)
		admin.POST("/withdrawals/:id/approve", balanceHandler.ApproveWithdrawal)
		admin.POST("/withdrawals/:id/reject", balanceHandler.RejectWithdrawal)
		...
		admin.PUT("/permissions", rbacHandler.UpdatePermissions)
		...
		// Alias routes for frontend compatibility
		admin.GET("/clients/blacklist", blacklistHandler.List)
		admin.POST("/clients/blacklist", blacklistHandler.Create)
		admin.PUT("/clients/blacklist/:id", blacklistHandler.Update)
		admin.DELETE("/clients/blacklist/:id", blacklistHandler.Delete)
		...
		admin.GET("/member-settings", setHandler.GetMemberSettings)
		admin.PUT("/member-settings", setHandler.UpdateMemberSettings)
		...
		if deps.WechatAppID != "" {
			...
			admin.GET("/wechat/config", wechatHandler.GetConfig)
			admin.GET("/wechat/pay/config", wechatHandler.GetPayConfig)
			admin.GET("/wechat/message/config", wechatHandler.GetMessageConfig)
			admin.PUT("/wechat/config", wechatHandler.UpdateConfig)
			admin.PUT("/wechat/pay/config", wechatHandler.UpdatePayConfig)
			admin.PUT("/wechat/message/config", wechatHandler.UpdateMessageConfig)
			admin.POST("/wechat/pay/test", wechatHandler.TestPay)
		}
        ...
        // ===== Frontend alias routes (currency-settings, fund-config, receipt-config) =====
        admin.GET("/currency-settings", currencyHandler.AdminGetList)
        admin.POST("/currency-settings", currencyHandler.AdminCreate)
        admin.PUT("/currency-settings/:id", currencyHandler.AdminUpdate)
        admin.DELETE("/currency-settings/:id", currencyHandler.AdminDelete)
        admin.GET("/fund-config", configGeneralHandler.GetRechargeConfig)
        admin.PUT("/fund-config", configGeneralHandler.UpdateRechargeConfig)
        admin.GET("/receipt-config", voucherHandler.GetRate)
        admin.PUT("/receipt-config", voucherHandler.PostRate)
